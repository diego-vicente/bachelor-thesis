...
\begin{titlepage}
  ...
  \centerline{This work is licensed under a Creative Commons}
  \centerline{\textbf{Attribution - NonCommercial - NoDerivatives}}
...
\input{2-state-art.tex}
\input{3-objectives.tex}
\input{4-development.tex}
\input{5-testing.tex}
\input{6-organization.tex}
